...
class PurchaseOrderController extends AccountBaseController
{
    ...
    public function create()
    {
        ...
        $this->estimate = Estimate::with('client', 'client.projects')->get();
    ...
    public function store(StoreRequest $request)
    {
        ...
        $order->estimate_id = $request->estimate_id;
    ...
    public function show($id)
    {
        ...
        $this->estimate = Estimate::with('client', 'client.projects')->findOrFail($this->order->estimate_id);
    ...
    public function edit($id)
    {
        ...
        $this->estimate = Estimate::with('client', 'client.projects')->get();
        $this->estimate_info = Estimate::where('id', $this->order->estimate_id)->sum('total');
        $this->purchase_total = PurchaseOrder::where('estimate_id', $this->order->estimate_id)->sum('total');
