...
use Modules\Purchase\Http\Controllers\RequisitionsController;
...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    // requisitions
    Route::post('requisitions/{id}/action', [RequisitionsController::class, 'action'])
    ->name('requisitions.action');
