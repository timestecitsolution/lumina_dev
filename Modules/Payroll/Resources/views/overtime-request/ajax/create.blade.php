        ...
        <div class="form-body">
            <div class="row">
                ...
                <div class="pt-20 pr-20 row">
                    ...
                    <div class="col-md-3 col-lg-3" id="set-time-estimate-fields" style="display: none;">
                        <div class="form-group mt-5">
                            <input type="number" min="0" class="w-25 border rounded p-2 height-35 f-14"
                                   name="overtime_hours[]" value="9">
                            @lang('app.hrs')
                            &nbsp;&nbsp;
        ...
        if(id != '' && id != undefined)
        {
            ...
            $.easyAjax({
                ...
                success: function (response) {
                    ...
                    let applyDate = moment(response.applyDate).format('YYYY-MM-DD');
                    let lastDate = moment(response.currentMonthDate).format('YYYY-MM-DD');
                
                    initializeDatePicker('#dateField1'); 
                
                    $('#start_date').val(applyDate).trigger('change');
                    $('#end_date').val(lastDate).trigger('change');
                }
            });
        }
