...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::prefix('loans')->group(function () {
        ...
        Route::get('/create', [EmployeeLoanController::class,'create'])->name('loan.create');
        Route::post('/store', [EmployeeLoanController::class,'store'])->name('loan.store');
        Route::get('/getEmployeeLoanInfo', [EmployeeLoanController::class, 'getEmployeeLoanInfo'])
        ->name('getEmployeeLoanInfo');
        Route::get('/{id}', [EmployeeLoanController::class,'show'])->name('loan.show');
        Route::post('/{id}/approve', [EmployeeLoanController::class,'approve'])->name('loan.approve');
        Route::post('/{id}/pay', [EmployeeLoanController::class,'pay'])->name('loan.pay');
        Route::get('/{id}/edit', [EmployeeLoanController::class,'edit'])->name('loan.edit');
        
        Route::put('/{id}', [EmployeeLoanController::class,'update'])->name('loan.update');
    ...
    Route::post('contractor-types/{id}/toggle-status', [ContractorTypeController::class, 'toggleStatus'])->name('contractor-types.toggleStatus');
    Route::resource('contractor-types', ContractorTypeController::class);



    Route::post('contractors/{id}/toggle-status', [ContractorController::class, 'toggleStatus'])->name('contractors.toggleStatus');
    ...
    Route::post('steps/{id}/toggle-status', [StepController::class, 'toggleStatus'] )->name('steps.toggle-status');
    Route::resource('steps', StepController::class);

    


    Route::post('deeds/{id}/toggle-status', [DeedController::class, 'toggleStatus'])->name('deeds.toggle-status');
    Route::get('get-sections-by-project/{project}', [DeedController::class, 'getSections'])->name('deed.getSections');
    Route::get('get-steps-by-section/{section}', [DeedController::class, 'getSteps'])->name('deed.getSteps');
    ...
    Route::get('get_estimate_info', [EstimateController::class, 'getEstimateInfo'])->name('get_estimate_info');
    ...
    Route::resource('product-files', ProductFileController::class);
      ...
      /* Investment FILES */
    Route::get('investment-files/download/{id}', [InvestmentFileController::class, 'download'])->name('investment-files.download');
    Route::post('investment-files/delete-image/{id}', [InvestmentFileController::class, 'deleteImage'])->name('investment-files.delete_image');
    Route::post('investment-files/update-images', [InvestmentFileController::class, 'updateImages'])->name('investment-files.update_images');
    Route::resource('investment-files', InvestmentFileController::class);
    ...
    Route::get('deal-report/visit', [LeadReportController::class, 'visitHistory'])->name('lead-report.visit');
    Route::get('deal-report/follow', [LeadReportController::class, 'followHistory'])->name('lead-report.follow');
