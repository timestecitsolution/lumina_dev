...
Route::group(['middleware' => 'auth', 'prefix' => 'account/settings'], function () {
    ...
    Route::post('validation-settings/store_permission', [ValidationSettingController::class, 'store_permission'])->name('validation-settings.store_permission');
    Route::post('validation-settings/update_permission/{validationRoleId}', [ValidationSettingController::class, 'update_permission'])->name('validation-settings.update_permission');
    Route::delete('validation-settings/destroy_permission/{id}', [ValidationSettingController::class, 'destroy_permission'])
     ->name('validation-settings.destroy_permission');
    Route::resource('validation-settings', ValidationSettingController::class);
