            ...
            <div class="select-box d-flex pr-2 border-right-grey border-right-grey-sm-0">
                ...
                <div class="select-status d-flex">
                    <input type="text" class="position-relative text-dark form-control border-0 p-2 text-left f-14 f-w-500 border-additional-grey"
                        id="datatableRange3" placeholder="@lang('placeholders.dateRange')">
                </div>
            </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function getDate() {
            ...
            $('#datatableRange3').daterangepicker({
        ...
        $(function() {
            getDate()
            $('#datatableRange3').on('apply.daterangepicker', function(ev, picker) {
                showTable();
            });

        });

        $('#lead-note-table').on('preXhr.dt', function(e, settings, data) {

            var dateRangePicker = $('#datatableRange3').data('daterangepicker');
            var startDate = $('#datatableRange3').val();
        ...
        const showTable = () => {
            window.LaravelDataTables["lead-note-table"].draw(true);
        }
