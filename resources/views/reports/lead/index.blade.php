...
@section('filter-section')
    ...
    <div class="d-flex filter-box project-header bg-white">
        ...
        <div class="project-menu d-lg-flex" id="mob-client-detail">
            ...
            <x-tab :href="route('lead-report.visit') . '?tab=visit'" :text="__('modules.leadContact.visitHistory')" class="visit" ajax="false" />
            <x-tab :href="route('lead-report.follow') . '?tab=follow'" :text="__('modules.leadContact.followHistory')" class="follow" ajax="false" />
        </div>
