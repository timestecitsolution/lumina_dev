            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    @if (user()->permission('add_expenses') == 'all')
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="form-group">
                                <x-forms.label class="my-3" fieldId="selectUser" :fieldLabel="__('app.employee')">
                                </x-forms.label>

                                <x-forms.input-group>
                                    <select class="form-control multiple-user" multiple name="user_id[]" id="selectUser" data-live-search="true" data-size="8">
                                        @foreach ($employees as $item)
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        @else
                            <x-forms.select fieldId="" fieldName="project_id" :fieldLabel="__('app.project')" fieldRequired="true"
                                search="true">
                                <option value="">--</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="category_id" id="expense_category_id" required
