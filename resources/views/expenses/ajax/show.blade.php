<div class="row">
    <div class="col-sm-12">
        <x-cards.data :title="__('app.menu.expenses') . ' ' . __('app.details')" class=" mt-4">
            ...
            <x-cards.data-row :label="__('app.bill_no')" :value="$expense->bill_no" />
            <x-cards.data-row :label="__('app.challan_no')" :value="$expense->challan_no" />
            ...
            <x-cards.data-row :label="__('app.employee')" :value="$employeeNames ?? '--'" />
