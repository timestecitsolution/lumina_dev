...
@section('content')
    ...
    <div class="content-wrapper">
        <x-forms.link-primary :link="route('contractor-types.create')"  icon="plus">
                        Add Contractor Type
...
@push('scripts')
    ...
    <script>
        ...
        const showTable = () => {
            window.LaravelDataTables["contractor-type-table"].draw();
        };

        $('#contractor-type-table').on('preXhr.dt', function (e, settings, data) {
        ...
        $(document).on('change', '.toggle-status', function () {
            ...
            $.easyAjax({
                url: "{{ url('account/contractor-types') }}/" + id + "/toggle-status",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
