        ...
        <x-form id="save-lead-data-form" >
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="form-group">
                                <x-forms.label class="my-3" fieldId="selectProject" fieldRequired="true" :fieldLabel="__('app.project')">
                                </x-forms.label>

                                <x-forms.input-group>
                                    <select class="form-control multiple-project" multiple name="project_id[]" id="selectProject" data-live-search="true" data-size="8">
