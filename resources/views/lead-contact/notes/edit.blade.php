            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row px-4">
                    ...
                    <div class="col-md-3 col-lg-4">
                        <x-forms.datepicker fieldId="note_date" fieldRequired="true"
                                            :fieldLabel="__('app.note_date')"
                                            fieldName="note_date" :fieldPlaceholder="__('placeholders.date')"
                                            :fieldValue="$note->note_date"/>
                    </div>

                    <div class="col-md-3 col-lg-4">
                        <x-forms.datepicker fieldId="next_date" fieldRequired="true"
                                            :fieldLabel="__('app.next_date')"
                                            fieldName="next_date" :fieldPlaceholder="__('placeholders.date')"
                                            :fieldValue="$note->next_date"/>
                    </div>
                    ...
                    <div class="col-md-3 col-lg-4">
                        <div class="form-group my-3">
                            <x-forms.label fieldId="visit_yes" :fieldLabel="__('app.visited_today')">
                            </x-forms.label>
                            <div class="d-flex">
                                <x-forms.radio fieldId="no" :fieldLabel="__('app.no')" fieldName="visit_yes"
                                    fieldValue="0"  :checked="$note->visit_yes==0">
                                </x-forms.radio>
                                <x-forms.radio fieldId="yes" :fieldLabel="__('app.yes')" fieldValue="1"
                                    fieldName="visit_yes" :checked="$note->visit_yes==1"></x-forms.radio>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#note_date').each(function (ind, el) {
            datepicker(el, {
                position: 'bl',
                ...datepickerConfig
            });
        ...
        $('#next_date').each(function (ind, el) {
            datepicker(el, {
                position: 'bl',
                ...datepickerConfig
            });
