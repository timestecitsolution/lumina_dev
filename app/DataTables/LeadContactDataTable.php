...
class LeadContactDataTable extends BaseDataTable
{
    ...
    protected function getColumns()
    {
        ...
        $data = [
            ...
            // __('modules.lead.email') => ['data' => 'email', 'name' => 'leads.client_email', 'exportable' => false,'visible' => false 'title' => __('modules.lead.email')],
            ...
            __('app.lead') => ['data' => 'export_mobile', 'name' => 'mobile', 'exportable' => false, 'title' => __('modules.lead.mobile')],
            ...
            __('app.deal_name') => ['data' => 'deal_name', 'name' => 'deal_name', 'exportable' => true, 'title' => __('app.deal_name')],
            __('app.stage_name') => ['data' => 'stage_name', 'name' => 'stage_name', 'exportable' => true, 'title' => __('app.stage_name')],
            __('app.createdOn') => ['data' => 'close_date', 'name' => 'leads.created_at', 'title' => __('app.createdOn')],
        ];
