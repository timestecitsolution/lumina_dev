...
class LeaveDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('created_at', function ($row) {
                return Carbon::parse($row->created_at)->translatedFormat($this->company->date_format) . ' (' . Carbon::parse($row->created_at)->translatedFormat('l') . ')';
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            __('app.appliedDate') => ['data' => 'created_at', 'name' => 'leaves.created_at', 'title' => __('app.appliedDate')],
