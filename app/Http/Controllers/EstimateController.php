...
class EstimateController extends AccountBaseController
{
    ...
    public function getEstimateInfo(Request $request)
    {
        $estimate_id = $request->estimate_id;

        $estimate_info = Estimate::where('id', $estimate_id)->sum('total');
        $purchase_total = PurchaseOrder::where('estimate_id', $estimate_id)->sum('total');
