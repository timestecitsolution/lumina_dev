...
class LeadContactController extends AccountBaseController
{
    ...
    public function show($id)
    {
        ...
        $selectedProjects = json_decode($this->leadContact->project_id, true) ?? [];
        $allProjects = Project::whereIn('id', $selectedProjects ?? [])->get();

        
        $this->projectNames = $allProjects->map(fn($p) => $p->project_name ?? $p->name)
                                    ->implode(', ');
    ...
    public function store(StoreRequest $request)
    {
        ...
        $leadContact->project_id = json_encode($request->project_id);
    ...
    public function edit($id)
    {
        ...
        $this->projects = Project::all();
        $this->selectedProjects = json_decode($this->leadContact->project_id, true) ?? [];
